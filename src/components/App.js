  ...
  return (
    ...
    <Router basename={'/#'}>
        ...
        <header className='fixed-top'>
            ...
            <button className='dark-toggle float-left btn' id={isDark ? null : 'darkmode-darkModeButton'} onClick={ () => toggleDarkMode()}>
              <i class="far fa-lightbulb" id={isDark ? null : 'lightbulb-darkMode'}></i>
            </button>
